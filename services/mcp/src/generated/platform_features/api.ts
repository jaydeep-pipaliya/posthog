...
export const PropertyAccessControlsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        organization_member: zod.string().nullish().describe('The organization member UUID to set an override for.'),
        role: zod.string().nullish().describe('The role UUID to set an override for.'),
    })
    .describe(
