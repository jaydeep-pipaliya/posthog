...
from posthog.temporal.session_replay.session_summary.activities.a5c_store_video_session_summary import (
...
async def test_store_video_session_summary_activity_emits_summary_ready_event(
    ...
    mocker.patch(
        "posthog.temporal.session_replay.session_summary.activities.a5c_store_video_session_summary.get_redis_state_client",
        return_value=(None, "input-key", None),
    )
    mocker.patch(
        "posthog.temporal.session_replay.session_summary.activities.a5c_store_video_session_summary.get_data_class_from_redis",
        return_value=llm_input,
    )
    mocker.patch(
        "posthog.temporal.session_replay.session_summary.activities.a5c_store_video_session_summary._convert_video_segments_to_session_summary",
        return_value=mock_session_summary_serializer.data,
    )

    capture_session_summary_ready = mocker.patch(
        "posthog.temporal.session_replay.session_summary.activities.a5c_store_video_session_summary.capture_session_summary_ready"
    )
...
async def test_store_video_session_summary_activity_does_not_emit_existing_summary_ready_event(
    ...
    logger = mocker.patch(
        "posthog.temporal.session_replay.session_summary.activities.a5c_store_video_session_summary.logger"
    )
